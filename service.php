                ...
                <div class="container mt-5 ">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Gestion des services</h6>
                            ...
                            <button class="btn btn-success" data-toggle="modal" data-target="#formModal">
                                Ajouter un service <i class="fas fa-home"></i>
                            </button>
                                        ...
                                        <div class="modal-body">
                                            <form id="addServiceCategoryForm" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="firstName" name="nom_service" required>
                                                </div>
                                                <div class="modal-footer">
                                                    <input type="submit" class="btn btn-primary" name="service" value="Valider">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $recup = $connexion->prepare("SELECT * FROM  service  ORDER BY id_service DESC ");
                                        $recup->execute();
                                        while ($trouv = $recup->fetch()) {
                                        ?>
                                            <tr>
                                                <td><?php echo $trouv['id_service']; ?></td>
                                                <td><?php echo $trouv['nom_service']; ?></td>
                                                <td><?= date('d/m/Y', strtotime($trouv['date_service'])); ?></td>

                                                <td>
                                                    <!-- button de modification -->
                                                    <button class="btn btn-sm btn-warning me-2" data-toggle="modal" data-target="#modifModal<?php echo $trouv['id_service']; ?>">
                                                        <i class='fas fa-edit text-light'></i>
                                                    </button>
                                                    <!-- moodal de modification -->
                                                    <div class="modal fade" id="modifModal<?php echo $trouv['id_service']; ?>" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="formModalLabel">Modification service</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form id="addUserForm" action="" method="post">
                                                                        <input type="hidden" value="<?php echo $trouv['id_service']; ?>" name="modif">

                                                                        <div class="form-group">
                                                                            <label for="username">Service :</label>
                                                                            <input type="text" class="form-control" id="service" name="nom_service" value="<?php echo $trouv['nom_service']; ?>" required>
                                                                        </div>                                                                      
                                                                      <div class="form-group">                                                                  
                                                                            <div class=" modal-footer">
                                                                                <button type="submit" class="btn btn-primary" name="modifservice">Oui</button>
                                                    ...
                                                    <button class="btn btn-sm btn-danger me-2" data-toggle="modal" data-target="#supModal<?php echo $trouv['id_service']; ?>"><i class="fas fa-trash all text-light"></i></button>
                                                    <!-- modal de supression -->
                                                    <div class="modal fade" id="supModal<?php echo $trouv['id_service']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="" method="post">
                                                                    <input type="hidden" name="supp" value="<?php echo $trouv['id_service']; ?>">
                                                                    <div class="modal-body">Etes vous sur de vouloir supprimer ce service <?php echo $trouv['nom_service']; ?> ?</div>
                                                                    <div class="modal-footer">
                                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Non</button>
                                                                        <input type="submit" class="btn btn-danger" name="supprimerservice" value="Oui">
