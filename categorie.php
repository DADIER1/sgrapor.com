    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <img src="sgepp.png" alt="" width="140" height="40">
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="categorie.php">Categories</a>
                ...
                <div class="container mt-5 ">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Gestion des categories</h6>
                            ...
                            <div class="d-flex flex-wrap justify-content-end">
                                <button class="btn btn-success" data-toggle="modal" data-target="#formModal">
                                    Ajouter une categorie <i class="fas fa-home"></i>
                                </button>
                                <!-- Le formulaire modal combiné pour le service et la catégorie -->
                                <div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="formModalLabel">Ajouter un Service</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <form id="addServiceCategoryForm" action="" method="post">
                                                    <!-- Section Informations Générales -->
                                                    <div class="form-group">
                                                        <label for="firstName">Categorie :</label>
                                                        <input type="text" class="form-control" id="firstName" name="nom_categorie" required>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <input type="submit" class="btn btn-primary" name="categorie" value="Valider">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $recup = $connexion->prepare("SELECT * FROM  categorie  ORDER BY id_categorie DESC ");
                                        $recup->execute();
                                        while ($trouv = $recup->fetch()) {
                                        ?>
                                            <tr>
                                                <td><?php echo $trouv['id_categorie']; ?></td>
                                                <td><?php echo $trouv['nom_categorie']; ?></td>
                                                <td><?= date('d/m/Y', strtotime($trouv['date_categorie'])); ?></td>

                                                <td>
                                                    <!-- button de modification -->
                                                    <button class="btn btn-sm btn-warning me-2" data-toggle="modal" data-target="#modifModal<?php echo $trouv['id_categorie']; ?>">
                                                        <i class='fas fa-edit text-light'></i>
                                                    </button>
                                                    <!-- moodal de modification -->
                                                    <div class="modal fade" id="modifModal<?php echo $trouv['id_categorie']; ?>" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="formModalLabel">Modification categorie</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form id="addUserForm" action="" method="post">
                                                                        <input type="hidden" value="<?php echo $trouv['id_categorie']; ?>" name="modif">

                                                                        <div class="form-group">
                                                                            <label for="username">Service :</label>
                                                                            <input type="text" class="form-control" id="service" name="nom_categorie" value="<?php echo $trouv['nom_categorie']; ?>" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class=" modal-footer">
                                                                                <button type="submit" class="btn btn-primary" name="modifcategorie">Oui</button>
                                                    ...
                                                    <button class="btn btn-sm btn-danger me-2" data-toggle="modal" data-target="#supModal<?php echo $trouv['id_categorie']; ?>"><i class="fas fa-trash all text-light"></i></button>
                                                    <!-- modal de supression -->
                                                    <div class="modal fade" id="supModal<?php echo $trouv['id_categorie']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="" method="post">
                                                                    <input type="hidden" name="supp" value="<?php echo $trouv['id_categorie']; ?>">
                                                                    <div class="modal-body">Etes vous sur de vouloir supprimer ce service <?php echo $trouv['nom_categorie']; ?> ?</div>
                                                                    <div class="modal-footer">
                                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Non</button>
                                                                        <input type="submit" class="btn btn-danger" name="supprimercategorie" value="Oui">
